...
namespace CodeLens.Infrastructure.Migrations
{
    ...
    [Migration("20260630074444_AddFileChunkSearchVector")]
    partial class AddFileChunkSearchVector
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeLens.Domain.Entites.Graph.FileContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FileContents", (string)null);
                });

            modelBuilder.Entity("CodeLens.Domain.Entites.Graph.GraphEdge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RepositoryId", "SourceId");
            ...
            modelBuilder.Entity("CodeLens.Domain.Entites.Graph.GraphNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeLens.Domain.Entites.Graph.FileContent", b =>
                {
                    b.HasOne("CodeLens.Domain.Entites.RepositoryFile", "RepositoryFile")
                        .WithMany()
                        .HasForeignKey("RepositoryFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CodeLens.Domain.Entites.Graph.GraphEdge", b =>
                {
                    ...
                    b.HasOne("CodeLens.Domain.Entites.Graph.GraphNode", "Source")
                        .WithMany("OutgoingEdges")
                        .HasForeignKey("SourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CodeLens.Domain.Entites.Graph.GraphNode", "Target")
